...
pub fn build() -> tauri::Builder<tauri::Wry> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::commands::conversation_list_all,
            ...
            crate::commands::chat_message_list_all,
            crate::commands::chat_message_update,
            crate::commands::chat_message_delete_many,
            crate::commands::term_list_all,
            crate::commands::tone_list_all,
            crate::commands::hotkey_list_all,
            crate::commands::app_target_list_all,
            crate::commands::app_target_delete,
